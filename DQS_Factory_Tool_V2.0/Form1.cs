...
namespace DQS_Factory_Tool_V2._0
{
    public partial class Form1 : Form
    {
        ...
        */
         ...
         */
        private void vGetPort()
        {

            string[] ports = SerialPort.GetPortNames(); // Get infor Port
            //for (int i =0; i < ports.Length; i+= ports.Length)
            //Array.Sort(ports, StringComparer.InvariantCulture); // Thêm vào khi dùng nạp với công tắc
            if (ports.Length > 0 && ports.Length <= 4)
            {
                int i = ports.Length;
                if (ports.Length == 1)
                {
        ...
        private void vProcessFirmware()
        {
            ...
            try
            {
                ...
                if (cbPort4.Text != "")
                {
                    ...
                    {
                        string error = outPut.Substring(outPut.Length - 50, 50);
        ...
        private void vProcessProduct()
        {
            ...
            try
            {
                ...
                using (Process process = new Process())
                {
                    ...
                    //process.StartInfo.FileName = Application.StartupPath + "cp210xsmt.exe";
                    process.StartInfo.UseShellExecute = false;
                    process.StartInfo.RedirectStandardOutput = true;
                    //process.StartInfo.Arguments = "--device-count 1 --set-config cp2102n_a02_gqfn20.configuration.1.1";
                    ...
                    //string newOutput = output.Substring(output.Length - 4, 4);
                    //tbStatusUSB.Text = newOutput;
                    //tbStatusUSB.BackColor = Color.Lime;
                    ...
                    //{
                    //    tbStatusUSB.Text = "FAILED";
                    //    tbStatusUSB.BackColor = Color.Red;
                    //}
                    //else
                    //{
                        //vProcessShow();
                            ...
                            case 3:
                                {
                                    ...
                                    //tbStatusPermitJoin.Text = "Command Failed";
                ...
                case 0x8011:
                    {
                        ...
                        strData += " (APS Data ACK)";
                        strData += "\n";
                        strData += "   Status: 0x" + au8Data[0].ToString("X2");
                        strData += "\n";
                        strData += "   SQN: 0x" + au8Data[1].ToString("X2");
                        strData += "\n";
                        strData += "   Source EndPoint: 0x" + au8Data[2].ToString("X2");
                        strData += "\n";
                        strData += "   Destination EndPoint: 0x" + au8Data[3].ToString("X2");
                        strData += "\n   ";
                ...
                case 0x8501:
                    {
                        ...
                        {
                            strData += "  Node Addr: 0x" + u64RequestNodeAddress.ToString("X16");
                            strData += "\n";
                        }

                        strData += "  File Offset: 0x" + u32FileOffset.ToString("X8");
                        strData += "\n";
                        ...
                        strData += "\n";
                        strData += "  Block Delay: 0x" + u16BlockRequestDelay.ToString("X4");
                        strData += "\n";
                        strData += "  Max Data Size: 0x" + u8MaxDataSize.ToString("X2");
                        strData += "\n";
                        strData += "  Field Control: 0x" + u8FieldControl.ToString("X2");
                        strData += "\n";
                        */
                        // Send response 
                ...
                case 0x8600:
                    {
                        ...
                        strData += " (Retrieve Network Recovery Response)";
                        strData += "\n";
                        //strData += nwkRecovery.ToString();
                        strData += "\n";
                    }
                    break;
